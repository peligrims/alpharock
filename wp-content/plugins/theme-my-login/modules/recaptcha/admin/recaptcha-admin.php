...
class Theme_My_Login_Recaptcha_Admin extends Theme_My_Login_Abstract {
	...
	public function get_themes() {
		$recaptcha_themes = array(
			'red'        => _x( 'Красный (по умолчанию)', 'recaptcha theme', 'theme-my-login' ),
			'white'      => _x( 'Белый',         'recaptcha theme', 'theme-my-login' ),
			'blackglass' => _x( 'Черное стекло',   'recaptcha theme', 'theme-my-login' ),
			'clean'      => _x( 'Легкий',         'recaptcha theme', 'theme-my-login' )
		);
